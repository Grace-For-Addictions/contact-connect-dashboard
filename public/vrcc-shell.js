...
const ROOMS=[
 ...
 {id:'connector',name:'The Connector',ico:'🌐',accent:'#2f8f9d',side:'L',page:'Connector',
  tag:'Network',desc:'The Grace & Company recovery network — residences, recovery community centers, support services, wellness centers, faith communities, and allies. Search and request a warm connection.',
  peek:'A wall of living connections — every door in the recovery community, in one place.',
  inside:['Directory','Warm hand-off','Live openings'],
  quote:'“Every door is the right door — we route you to the one that fits.”',
  cards:[
   {i:'🏘️',t:'Residences & centers',d:'Recovery residences and community centers, accepting in real time.'},
   {i:'🤝',t:'Services & allies',d:'Support services, wellness centers, faith communities, and volunteers.'},
   {i:'🔎',t:'Search by need',d:'Find help by name, service, city, or what you need today.'},
   {i:'📩',t:'Warm connection',d:'Request a person-first introduction — no pressure, no judgment.'}]},
 {id:'contact',name:'Contact Connect',ico:'📝',accent:'#c8972a',side:'L',page:'Intake',
  tag:'Begin here',desc:'The participant intake — begin with grace. Share what you are comfortable sharing; only a few fields are required, and a coordinator makes warm contact within 48 hours.',
  peek:'A quiet desk, a warm welcome, and a form that meets you where you are.',
  inside:['Person-first','Mostly optional','48-hour follow-up'],
  quote:'“There is no wrong way to start. Begin with grace.”',
  cards:[
   {i:'🌿',t:'Who you are',d:'Your name and identity, in your words.'},
   {i:'📞',t:'How to reach you',d:'So a coordinator can make warm contact.'},
   {i:'💪',t:'Your recovery',d:'Strengths first — housing, support, and next steps.'},
   {i:'🤍',t:'Consent, your choice',d:'Always optional, never affecting your support.'}]},
