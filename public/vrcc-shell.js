...
const ROOMS=[
 ...
 {id:'staff',name:'Staff & Volunteer Area',ico:'🗝️',accent:'#5c6b7a',side:'R',locked:true,page:'Reports',
  tag:'Restricted',desc:'For coaches, volunteers, and operators. Sign in to continue.',
  peek:'Coach & volunteer workspace — reporting, coordination, care behind the scenes.',
  inside:['Coach tools','Reports','Coordination'],
